...
import type * as nodeUrl from "url";
...
declare global {
  interface Window extends Electron, RequestInitElectron {
    ...
    interface ElectronProps {
        ...
        process: NodeJS.Process & {machineId: string}
        appPath: Record<EnvName | "downloadPath" | "editedPath" | (string&{}), string>
        backend: string
        server: string
    }
}

interface NodePolyfill {
...
interface Electron {
  ...
  electronJS?: string | boolean;
  requestInit?: Prettify<RequestInitElectron>;
}
